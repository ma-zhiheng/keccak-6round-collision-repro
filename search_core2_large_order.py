"""Focused incremental search using the strongest observed row order."""
...
def main() -> None:
    ...
    print("focused large-order search for Table 7 core No. 2")
    ...
    for index in range(1, attempts + 1):
        ...
        if best is None or connector.added_g_rows > best[0]:
            ...
            print(
                ...
                f"rank={connector.system.rank}, dim={connector.system.dimension}, seed={seed}"
            )
