"""Model-level backtracking search for Table 7 trail core No. 2."""
...
from incremental_connector import build_model_backtracking_connector
...
def main() -> None:
    ...
    print("model-level backtracking for Table 7 core No. 2", flush=True)
    ...
    for index in range(1, attempts + 1):
        ...
        if best is None or connector.added_g_rows > best[0]:
            ...
            print(
                ...
                f"assigned={connector.assigned_sboxes}, nodes={connector.nodes}, "
                f"failed_row={connector.failed_row}, failed_deps={len(connector.failed_sboxes)}, "
                f"reason={connector.failure_reason}, order={order}, seed={seed}",
                flush=True,
            )
